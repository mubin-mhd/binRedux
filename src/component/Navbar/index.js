...
const Navbar = () => {
  ...
  const handleLogOut = () => {
    dispatch(logOut(loadingHandler));
  };

  return (
    <div>
      <nav class="relative px-4 py-4 flex justify-between items-center bg-[#198754]">
        <a class="text-3xl font-bold leading-none" href="#">
          <svg class="h-10 text-white" alt="logo" viewBox="0 0 10240 10240">
            <path
        ...
        <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
          ...
          <li>
            <Link to="/list-product">
              <button
                onClick={() => history.push("/list-product")}
                class="text-sm text-white hover:text-gray-100"
                href="#"
              >
                List Product
        ...
        <button
          ...
          class="hidden lg:inline-block py-2 px-6 bg-red-500 hover:bg-red-600 text-sm text-white font-bold rounded-xl transition duration-200"
        >
          Log Out
        </button>
      </nav>
